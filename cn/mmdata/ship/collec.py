...
def get_data():
    ...
    for i in range(1, 10, 2):
        ...
        reg1 = re.compile('<span class="(.*?)">')
        reg2 = re.compile('<a target="_blank" class="cate_menu_lk" href="(.*?)">>')
...
def save_data(zid, bt_):
    ...
    data.to_excel('C:\\Users\\Administrator\\Desktop\\2017\\python_file\\家居用品.xlsx', index=False)
